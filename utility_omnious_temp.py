...
class TrendData(Dataset):
    def __init__(self, conf):
        ...
        self.conf = conf
        trends, grp_ids, ele_ids, self.time_num, trend_norm, city_ids, gender_ids, age_ids, self.grp_id_map, self.ele_id_map = self.get_ori_data()
    ...
    def get_ori_data(self):
        ...
        return trends, np.array(grp_ids), np.array(ele_ids), time_num, np.array(trend_norm), np.array(
            city_ids), np.array(gender_ids), np.array(age_ids), grp_id_map, ele_id_map
